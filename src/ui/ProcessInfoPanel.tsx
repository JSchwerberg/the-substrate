  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          color: selectedProcess.status === 'idle' ? '#888' :
                 selectedProcess.status === 'moving' ? '#4ecdc4' :
                 selectedProcess.status === 'attacking' ? '#ef4444' :
                 selectedProcess.status === 'destroyed' ? '#666' : '#fbbf24',
          fontWeight: 600,
